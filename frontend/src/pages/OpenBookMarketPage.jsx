                ...
                <div className="flex flex-col gap-4">
                    <div className="">
                        <div className="font-sans text-xs uppercase text-gray-normal">
                            Base Token Address<span className="pl-1 text-red-normal">*</span>
                        </div>
                        <input
                    ...
                    <div className="">
                        <div className="font-sans text-xs uppercase text-gray-normal">
                            Quote Token Address<span className="pl-1 text-red-normal">*</span>
                        </div>
                        <input
                            className="outline-none border border-gray-border font-sans text-white placeholder:text-gray-border text-sm px-2.5 bg-transparent w-full h-button mt-1"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="col-span-1">
                            <div className="font-sans text-xs uppercase text-gray-normal">
                                Minimum Order Size<span className="pl-1 text-red-normal">*</span>
                            </div>
                            <input
                                className="outline-none border border-gray-border font-sans text-white placeholder:text-gray-border text-sm px-2.5 bg-transparent w-full h-button mt-1"
                        ...
                        <div className="col-span-1">
                            <div className="font-sans text-xs uppercase text-gray-normal">
                                Minimum Price Tick Size<span className="pl-1 text-red-normal">*</span>
                            </div>
                            <input
                                className="outline-none border border-gray-border font-sans text-white placeholder:text-gray-border text-sm px-2.5 bg-transparent w-full h-button mt-1"
