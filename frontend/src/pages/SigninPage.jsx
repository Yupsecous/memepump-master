    ...
    return (
        <div className={`flex items-center justify-center min-h-screen bg-gray-dark font-sans pb-7`}>
            <div className="relative max-sm:w-[450px] m-6 max-w-[500px] w-full">
                <IoIosLock className="text-[50px] text-red-normal mb-1" />
                <h2 className="text-lg font-bold text-white uppercase">Login</h2>
                <p className="mb-5 text-sm text-gray-normal">Enter your name and password to login</p>
