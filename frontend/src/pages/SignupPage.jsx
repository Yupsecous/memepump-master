...
export default function SignupPage() {
    ...
    return (
        <div className={`flex items-center justify-center min-h-screen bg-gray-dark font-sans pb-7`}>
            <RegisteredDialog isOpen={openRegistered} onOK={() => { navigate("/login"); }} />
            <div className="relative max-sm:w-[450px] m-6 max-w-[500px] w-full">
                <FaUserPlus className="text-[50px] text-red-normal mb-1" />
                <h2 className="text-lg font-bold text-white uppercase">Register</h2>
                <p className="mb-5 text-sm text-gray-normal">Enter your name and password to register</p>
                ...
                <div className="flex items-center justify-between mt-3 text-sm text-gray-normal">
                    <p>
                        ...
                        <Link to="/login" className="text-red-normal hover:underline">
                            Login
                        </Link>
                    </p>
                    <p>
