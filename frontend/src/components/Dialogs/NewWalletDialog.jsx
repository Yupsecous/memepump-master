            ...
            <div className="flex flex-col pt-5 w-[440px] font-sans">
                ...
                <div className="items-center w-full h-auto px-5 py-5 md:py-0 bg-gray-dark rounded-b-md">
                    ...
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" value="" checked={fresh} class="sr-only peer" onChange={(e) => setFresh(e.target.checked)} />
                        <div class="relative w-[30px] mt-3 h-4 bg-gray-border peer-focus:outline-none rounded-full peer focus:outline-none peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full after:content-[''] after:absolute after:top-[1px] after:start-[1px] after:bg-[#ffffffb0] after:rounded-full after:h-3.5 after:w-3.5 after:transition-all peer-checked:bg-red-normal"></div>
                        <span class="ml-3 mt-3 text-sm text-gray-normal">Fresh Wallet</span>
                    </label>
